...
ブラウザ上で手書きできるノートアプリ。**赤色（マーカー色）で手書きの質問を囲うと、Claude が読み取って回答を直下に手書き風で書き込みます。**
...
1. 黒のペンで質問を手書き（例: `2 + 3 = ?`）
2. ツールバーで **赤(AI)** に切り替え、質問を囲む（始点と終点が近づいた閉ループのみ反応）
...
| ボタン | 動作 |
| --- | --- |
| 黒 | 通常の筆記。AI トリガにはならない |
| 赤(AI) | このペンで囲うと AI が起動 |
| 細 / 中 / 太 | 線の太さ（2 / 4 / 8px） |
